const troublesItems = [
  {
    id: 1,
    thumbnail: 'https://miro.medium.com/max/3600/1*6ahbWjp_g9hqhaTDSJOL1Q.png',
...
.dropdown-item {
  ...
  {
    id: 2,
    thumbnail: 'https://i1.wp.com/www.whileifblog.com/wp-content/uploads/2020/04/o-que-e-o-css3.jpg?fit=1280%2C720&ssl=1',
  ...
  {
    id: 3,
    thumbnail: 'https://techbeacon.com/sites/default/files/styles/social/public/html5-mobile-app-native-hybrid-pros-cons.jpg?itok=R3pMKIzh',
  ...
  {
    id: 4,
    thumbnail: 'https://logz.io/wp-content/uploads/2020/09/Node.JS-and-Observability-1-1024x536.png',
  ...
  {
    id: 8,
    thumbnail: 'https://miro.medium.com/max/720/1*LjR0UrFB2a__5h1DWqzstA.png',
    title: 'AWS EC2를 이용해서 백엔드 api 서버 만들기',
    description: '요즘에는 정적 인터넷 웹페이지를 S3에 올리고 EC2를 백엔드 api로 활용하는 방식을 많이 쓰는 것 같다. 별도의 자동화 툴 없이도 S3에 변화된 내용을 바로 적용할 수 있어 개발하기 좋다.',
    category: 'js'
  },
  ...
  {
    id: 10,
    thumbnail: 'https://d1.awsstatic.com/icons/jp/console_s3_icon.64795d08c5e23e92c12fe08c2dd5bd99255af047.png',
    title: '웹 앱에서 AWS S3에 파일 올리는 방법',
    description: 'AWS의 콘솔에서 S3에 파일을 직접 올리는 방법도 있지만 앱에서 사용자가 파일을 올릴 수 있게 하려면 web에서 javascript 코드를 이용해 파일을 올리는 방법을 알아야 한다.',
    category: 's3'
  },
